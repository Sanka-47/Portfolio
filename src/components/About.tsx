        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="flex items-start space-x-3 p-4 rounded-xl bg-slate-100/50 border border-slate-200">
                <MapPin className="w-5 h-5 text-secondary flex-shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-slate-900 text-sm">Location</h4>
                  <p className="text-xs text-slate-600">Ukuwela, Sri Lanka</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 p-4 rounded-xl bg-slate-100/50 border border-slate-200">
                ...
                <div>
                  <h4 className="font-semibold text-slate-900 text-sm">Interests</h4>
                  <p className="text-xs text-slate-600">Kandyan Dancing, Swimming, Badminton</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="glass-card p-6 rounded-2xl relative overflow-hidden">
              ...
              <div className="space-y-6 relative border-l border-slate-200 pl-4 ml-2">
                ...
                <div className="relative">
                  <div className="absolute -left-[21px] top-1.5 w-3.5 h-3.5 rounded-full bg-primary border-4 border-background" />
                  <span className="text-xs text-secondary font-semibold">Expected 2026</span>
                  <h4 className="font-bold text-slate-900 text-sm mt-0.5">B.Sc. (Honours) in Software Engineering</h4>
                  <p className="text-xs text-slate-600">Birmingham City University</p>
                </div>
                ...
                <div className="relative">
                  ...
                  <h4 className="font-bold text-slate-900 text-sm mt-0.5">High School Diploma</h4>
                  <p className="text-xs text-slate-600">Dharmaraja College, Kandy, Sri Lanka</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-6 rounded-2xl relative overflow-hidden">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-slate-900">Certifications & Achievements</h3>
              </div>
